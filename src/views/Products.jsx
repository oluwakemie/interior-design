    ...
    >
      <FadeIn delay={0.2} direction="right">
        <div className="flex flex-col">
          ...
          <button className="flex items-center gap-2 bg-transparent text-FontBlack border-transparent font-bold py-2 px-2 rounded-lg w-fit border hover:border-black outline-none focus:outline-none ease-linear transition-all duration-350 mx-auto 2xl:mx-0 2xl:mb-10 2xl:mb-0 ">
