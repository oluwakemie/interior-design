...
const Hero = () => {
  ...
  return (
    ...
    >
      <div className="relative w-full max-w-[1460px] flex items-center justify-between p-10 mx-auto px-10">
        <img src={logo} alt="" />
      ...
      <FadeIn delay={0.2} direction="down" padding fullWidth>
        <h1 className="mt-[90px] text-center text-4xl leading-tight xs:text-[64px] text-white max-w-[1050px]">
          {heroTitle}
        </h1>
      </FadeIn>
